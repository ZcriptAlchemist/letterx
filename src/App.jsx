...
function App() {
  const defaultOutput =
    "LetterX is a cutting-edge AI-powered writing companion, fueled by Google's Gemini technology. It's designed to elevate your professional communication by generating polished and persuasive letters. \n \n Think of LetterX as a highly trained assistant, meticulously crafted to craft letters that align with your specific needs and audience. Whether you need crystal-clear business proposals, compelling cover letters, or impactful emails, LetterX streamlines the process and ensures your message lands with impact. \n At its core, LetterX harnesses the vast knowledge of the Gemini LLM, allowing it to tailor each letter to your unique requirements. So, tell LetterX what kind of masterpiece you want to create today, and let's collaborate to craft a written work of art.";

  const [value, setValue] = useState("");
  const [loading, setLoading] = useState(false);
  const apiKey = import.meta.env.VITE_API_KEY;
  const [resData, setResData] = useState(defaultOutput);
